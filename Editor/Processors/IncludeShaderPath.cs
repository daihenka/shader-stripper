...
{
    internal class IncludeShaderPath : ShaderProcessor
    {
    ...
    [CustomEditor(typeof(IncludeShaderPath), true)]
    internal class IncludeShaderPathInspector : ShaderProcessorInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            base.OnInspectorGUI();
            DrawHelpBox("This processor will include shaders where their path matches the path filters.");
            m_List.DoLayoutList();
